                  ...
                  bool requireimprove)
{
    ...
    int edge[2];
    starreal thislong;
	tag boundfacelist[MAXINCIDENDTBFACET][3];
	int boundfacenumber = 0;
    ...
    */
    ...
    switch (edgecase)
    {
        ...
        case FIXEDFIXEDEDGE:
			...
			combinedincidentfacets(mesh,v1,v2,boundfacelist,&boundfacenumber);
            break;
        default:
    ...
    *minqualbefore = HUGEFLOAT;
	...
	if(edgecase == FIXEDFIXEDEDGE){
		addquadric(mesh,v1,boundfacelist,boundfacenumber);
	}
